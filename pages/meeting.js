    ...
    const screenShareHandler = async () => {
      if (!isScreenSharing) {
        ...
        socket.emit("screen-share", {
          meetingId: query.id,
          user: { uid: screenUserId, name: user.name + "'s Screen" },
        });
        ...
        navigator.mediaDevices
          ...
          .then((stream) => {
            ...
            const videoCard =
              document.getElementsByClassName("screen-share")[0];
            ...
            {loading ? (
              ...
              <>
                <div className={styles.header}>
                  <div className={styles.logo}>webview</div>
                  ...
                  <div className={`${styles.videoBox} videoBox`}>
                    ...
                    <div className={styles.controls}>
                      ...
                      {meeting.hostId === user.uid && (
                        <>
                          <div
                            className={`${styles.controlBtn} ${styles.endMeeting}`}
                            onClick={() => {
                              setShowDialog(true);
                            }}
                          >
                          ...
                          <DialogBox
                            show={showDialog}
                            question={
                              "Are you sure you want to end this meeting for all?"
                            }
                            clickOk={endMeetingHandler}
                            clickCancel={() => {
                              setShowDialog(false);
                            }}
                          />
                          ...
                          >
                            <div className={styles.messageSender}>
                              <i
                                ...
                                aria-hidden="true"
                              ></i>{" "}
                              {m.sender.uid == user.uid ? "You" : m.sender.name}
                            </div>
                            <div className={styles.messageBody}>
                              <Linkify>{m.body}</Linkify>
                            </div>
