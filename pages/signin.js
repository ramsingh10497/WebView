        ...
        <div className={styles.body}>
          ...
          <div className={styles.desktopContainer} id="container">
            <div
              className={
                activeIndex == 0
                  ? `${styles.formContainer} ${styles.signUpContainer}  ${styles.rightPanelActiveSignUpContainer}`
                  : `${styles.formContainer} ${styles.signUpContainer}`
              }
            >
              <form
                action="#"
            ...
            <div
              className={
                activeIndex == 0
                  ? `${styles.formContainer} ${styles.signInContainer} ${styles.rightPanelActiveSignInContainer}`
                  : `${styles.formContainer} ${styles.signInContainer} `
              }
            >
              <form
                action="#"
            ...
            <div
              className={
                activeIndex == 0
                  ? `${styles.overlayContainer} ${styles.rightPanelActiveOverlayContainer}`
            ...
            >
              <div
                className={
                  activeIndex == 0
                    ? `${styles.overlay} ${styles.rightPanelActiveOverlay}`
                    : `${styles.overlay}`
                }
              >
                <div
                  className={
                    activeIndex == 0
                      ? `${styles.overlayPanel} ${styles.overlayLeft} ${styles.rightPanelActiveOverlayLeft}`
                      : `${styles.overlayPanel} ${styles.overlayLeft}`
                  }
                >
                ...
                <div
                  className={
                    activeIndex == 0
                      ? `${styles.overlayPanel} ${styles.overlayRight} ${styles.rightPanelActiveOverlayRight}`
                      : `${styles.overlayPanel} ${styles.overlayRight}`
                  }
                >
